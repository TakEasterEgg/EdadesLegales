function calcular() {
    ...
    if (Mujer <= 17){
        ...
        document.getElementById('retextearMensaje').innerHTML= '<img src="/policia.jpg" class="img-fluid">'
        document.getElementById('musica').innerHTML='<audio controls autoplay> \
                                                    <source src="policia.mp3" type="audio/mpeg"> \
                                                    </audio>'
    ...
    document.getElementById('retextearMensaje').innerHTML='<img src="/Feliz.jpg" class="img-fluid">'
